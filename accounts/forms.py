...
from accounts.models import UserInfo, RoleList, PermissionList, RuleSet
    ...
    def clean_password(self):
        ...
        if username and password:
            ...
            if self.user_cache is None:
                ...
                raise forms.ValidationError(u'此账号尚不可用，需要激活')
...
class AddUserForm(forms.ModelForm):
    class Meta:
        model = UserInfo
        fields = ('username', 'password', 'email', 'wid', 'nickname', 'role', 'is_active')
        widgets = {
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['wid'].label = u'企业微信ID'
        self.fields['wid'].error_messages = {'required': u'请输入企业微信ID'}
...
class EditUserForm(forms.ModelForm):
    class Meta:
        model = UserInfo
        fields = ('username', 'email', 'wid', 'nickname', 'role', 'is_active', 'is_alert_enabled', 'ruleset')
        widgets = {
            ...
            'wid': forms.TextInput(attrs={'class': 'form-control', 'style': 'width:500px;'}),
            ...
            'is_alert_enabled': forms.Select(choices=((True, u'开'), (False, u'关')),
                                             attrs={'class': 'form-control',
                                                    'style': 'width:500px;'}),
            'ruleset': forms.Select(attrs={'class': 'form-control', 'style': 'width:500px;'}),
        }
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['role'].label = u'角 色'
        self.fields['is_active'].label = u'状 态'
        self.fields['is_alert_enabled'].label = u'告警通知'
        self.fields['ruleset'].label = u'通知规则列表'
...
class RuleSetForm(forms.ModelForm):
    def clean(self):
        cleaned_data = super(RuleSetForm, self).clean()
        return cleaned_data
    ...
    class Meta:
        ...
        widgets = {
            ...
            'ruleset': forms.SelectMultiple(
                attrs={'class': 'form-control', 'size': '10', 'multiple': 'multiple'}),
        }
