...
# SECRET_KEY = '@jisk&f$tu#-^^%k-dj__th2)7m!m*(ag!fs=6exxyt7l88888'
...
if ldap_enable == "True":
    ...
    print("is_active: {}".format(str(is_active)))
...
MEDIA_ROOT = os.path.join('/var/opt/alerts/data')
MEDIA_URL = '/media/'
